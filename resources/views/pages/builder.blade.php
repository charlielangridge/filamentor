        ...
        <div class="filamentor-canvas pt-4" x-data="filamentor" x-load-js="[
            ...
            <div id="rows-container" x-data="filamentor" class="space-y-4 bg-white dark:bg-gray-900 p-4 rounded-lg">
                ...
                <x-filament::modal id="element-editor-modal" width="4xl">
                    <x-slot name="heading">
                        Edit {{ str_contains($activeElementType ?? '', 'Text') ? 'Text' : (str_contains($activeElementType ?? '', 'Image') ? 'Image' : 'Video') }} Element
                    </x-slot>

                    <div class="min-h-[300px]" x-data="{ content: '' }">
                        <!-- Loading spinner -->
                        <div wire:loading wire:target="editElement" class="flex justify-center items-center h-64">
                        ...
                        <div wire:loading.remove wire:target="editElement">
                            {{ $this->getElementForm() }}
                        </div>
